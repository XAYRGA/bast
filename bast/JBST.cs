...
namespace xayrga.bast
{
    ...
    public class JBST
    {
        ...
        public static JBST fromStream(BeBinaryReader stream)
        {
            var nBST = new JBST();
            ...
            else
            {
                for (int i = 0; i < soundCount; i++)
                {
                    ...
                    switch (upperFormatType)
                    {
                        ...
                        case 0x70:
                        case 0x71:
                            lib.sounds[i] = JBSTStreamEntry.deserialize(stream);
                            break;
                        default:
    ...
    public abstract class JBSTSound
    {
        public short type;
#if RELEASE
        [JsonIgnore]
        ...
        public abstract void serialize(BeBinaryWriter stream);
    }

    public class JBSTNSound : JBSTSound // empty sound. Container format only.
    {
        ...
        public override void serialize(BeBinaryWriter stream)
        {
    ...
    public class JBSTStreamEntry : JBSTSound
    {
        ...
        public static JBSTStreamEntry deserialize(BeBinaryReader stream)
        {
            ...
            obj.streamPath = JBSTParseUtil.readNameAnchored(stream, obj.pathOffset);
            return obj;
        }
